...
class DataPreprocessor:
	def __init__(self, path_musan, path_vox1):
		self.path_musan = path_musan
		self.path_vox1_test = os.path.join(path_vox1, 'test')
		self.path_vox1_test_noise = os.path.join(path_vox1, 'test_noise')

		dir = self._leaf_dir(self.path_musan)
		self.path_musan_split = self.path_musan.replace(dir, f'{dir}_train_test_split')
	...
	def check_environment(self):
		...
		if not os.path.exists(self.path_musan_split):
			...
			print(f'path_musan_split exists: {self.path_musan_split}')
		...
		if not os.path.exists(self.path_vox1_test_noise):		
			...
			print(f'path_vox1_test_noise exists: {self.path_vox1_test_noise}')
